...
ggsave("./figures_for_report/constructed_routes_p4.png", width = 5, height = 5)

rc <- route_clustering(p_inst, init_routes, k, measure = "position-based", weigthed = F); cluster <- rc$cutree
...
ggsave("./figures_for_report/constructed_routes_w_zones_p4.png", width = 5, height = 5)
...
ggsave("./figures_for_report/dendogram_p4.png", width = 5, height = 5)
...
plot_zones_disputed(zones)
ggsave("./figures_for_report/overlapping_zones_p4.png", width = 5, height = 5)
...
plot_zones(zones)
ggsave("./figures_for_report/most_frequent_zones.png", width = 5, height = 5)
