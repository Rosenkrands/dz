...
ggsave("./figures_for_report/constructed_routes.png", width = 5, height = 5)
...
ggsave("./figures_for_report/constructed_routes_w_zones.png", width = 5, height = 5)
...
ggsave("./figures_for_report/dendogram.png", width = 5, height = 5)
...
ggsave("./figures_for_report/overlapping_zones.png", width = 5, height = 5)
